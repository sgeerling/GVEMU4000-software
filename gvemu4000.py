...
c_format = logging.Formatter('[%(asctime)s] eBot %(levelname)s %(name): %(message)s', datefmt='%d%m%y-%H:%M:%S')
f_format = logging.Formatter('[%(asctime)s] eBot %(levelname)s %(name): %(message)s', datefmt='%d%m%y-%H:%M:%S')
